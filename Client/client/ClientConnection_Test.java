...
public class ClientConnection_Test {
	...
	public static String login(ClientConnection cc, boolean connection) {
		if (connection) {
			...
			if (response.errorExist())
				...
				System.out
						.println("result:" + " " + response.getItem("result"));
	...
	public static void attachSocket(ClientConnection cc, boolean connection,
			String key) {
		Request request = new Request();
	...
	public static ArrayList<User> getUsers(ClientConnection cc,
			boolean connection) {
	...
	public static void getRooms(ClientConnection cc, Timestamp start,
			Timestamp end) {
	...
	public static void getApointments(ClientConnection cc, User user) {
		...
		if (response.errorExist())
			...
			ArrayList<Invitation> invitations = (ArrayList<Invitation>) response
					.getItem("invitations");
	...
	public static void addAppointment(ClientConnection cc, Timestamp start,
			Timestamp end, ArrayList<User> users) {
	...
	public static void addInvitation(ClientConnection cc,
			ArrayList<User> users, Event event) {
