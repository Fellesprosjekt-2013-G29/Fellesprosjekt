...
/**
 * Contains all the underlying functionality we need to encrypt and check passwords safely
 * The class will create salts of 16 bytes, hash passwords and it has a method to safely 
...
{
	//Antall ganger passordet hashes med saltet
	//denne bør være over 1000 ganger.
	private static final int ITERATIONS = 1042;
	
	/**
	 * Checks the inputet password against the hashed password.
	 * Works by encrypting the inputed password with the stored salt and
	 * comparing the resoult with the stored passwordhash.
	 * 
